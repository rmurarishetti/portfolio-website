...
import { geoPolygonTriangulate, coordinates2cartesian } from '../math';
...
class ConicPolygonBufferGeometry extends THREE.BufferGeometry {
    constructor(polygonGeoJson, startHeight, endHeight, closedBottom = true, closedTop = true, includeSides = true, curvatureResolution = 5) {
        super();
        ...
        function generateVertices(polygon, altitude) {
            const coords3d = polygon.map(coords => coords.map(([lng, lat]) => coordinates2cartesian(altitude, [lat, lng])));
